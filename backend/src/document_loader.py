...
def load_pdf(file_path):
    ...
    with pdfplumber.open(file_path) as pdf:
        for i, page in enumerate(pdf.pages):
            ...
            if text and text.strip():  # None check already correct hai
...
# Fix: load_financial_pdf() dead code tha — hata diya
# Fix: get_finance_chunks() bhi dead code tha — chunking.py se bhi hata diya
